...
def pretty_print(friends, output_file):
...
if __name__ == "__main__":
    ...
    parser.add_argument("output_file", type=str, default="data.txt", help="File where text is outputted.")
    ...
    # Print all users
    pretty_print(friends, output_file)